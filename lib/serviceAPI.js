...
serviceAPI.prototype.init = function() {
    ...
    this.app.post('/api/knowledgeRepo/getByTag', function(req, res) {
        knowledgeRepo.SelectByTagBD(req, function(response) {
            res.send(response)
        })
    });
    ...
    this.app.get('/api/knowledgeRepo/getAllTags', function(req, res) {
        knowledgeRepo.SelectAlllTagBD(req, function(response) {
            res.send(response)
        })
    });
