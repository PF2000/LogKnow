            ...
            <div class="box-body">
              <div class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="txtDatetime" class="form-control" type="text" placeholder="DateTime">
                  </div>
                </div>
                <!-- Summary -->
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="txtSummary" class="form-control" type="text" rows="3"></textarea>
                  </div>
                </div>
                <!-- Files -->
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="txtComments" class="form-control" type="text" rows="3"></textarea>
                  </div>
                </div>
